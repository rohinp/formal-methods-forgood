...
This repository teaches practical formal methods to application developers and
will eventually be used to create an AI coding-agent skill.

- Introduce one technique at a time. Keep examples and explanations focused.
- Implement each technique in Python, Scala 3, and Kotlin when it is useful and
...
- Cite authoritative external references from wiki pages where practical.
